...
function handleRefresh() { props.emit('refresh', { source: 'finance-panel', timestamp: Date.now() }); }
function handleExport() { props.emit('export', { data: tableData.value, total: totalProfit.value }); }
</script>
...
.finance-panel__desc { margin: 0 0 12px; color: #909399; font-size: 13px; }
