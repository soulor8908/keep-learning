<template>
  <div class="v2host">
    <header class="v2host__header">
      <h1>Vue2 Host <small class="v2host__tag">ESM + importmap</small></h1>
...
// ─── 同栈物料：ESM 直引 ───
// 与 UMD 版一致：同栈 Vue2 物料无需中转，直接 import SFC，由 Vite 编译挂载。
import SalesPanel from '../../../demo/vue2-widgets/src/widgets/sales-panel/SalesPanel.vue';
...
// element-ui 在基座的 Vue2 上注册一次即全局生效（同栈物料共享）
